...
(
    /* SERIAL is special type of Integer
       PRIMARY KEY is unique, could be different formats*/
...
/*authorities normally designs for admin*/
...
/*every customer has their carts, a customer can only have one cart. 1 ON 1
  PRIMARY KEY includes UNIQUE
  FOREIGN KEY could reinforce ID is associated with customer table*/
CREATE TABLE carts
(
    id          SERIAL PRIMARY KEY NOT NULL,
