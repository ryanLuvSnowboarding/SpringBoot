...
//function addMenuItemToCart needs @Transactional because there are two
//write actions, the first one is adding MenuItem into orderItemRepository
//, the second one is adding price to cart. If one write action is
// uncompleted the other write action should be revoked to sync.
    ...
    @Cacheable("cart")
//@Cacheable will read argument below i.e. customerId
